...
import {
    BadgeDollarSign, Search, Calendar, TrendingUp, Star,
    ChevronDown, ChevronRight, FileText, Users, DollarSign
} from 'lucide-react';
import Modal from '../components/Modal';
import EmptyState from '../components/EmptyState';
import api from '../services/api'; // Keep api import
import { StatusBadge } from '../utils/statusStyles'; // Keep StatusBadge import
...
export default function Commission() {
    ...
    const totals = report.reduce((acc, m) => ({
                                            ...
                                            >
                                                ...
                                                <td>
                                                    <div className="avatar-name">
                                                        <div className="avatar-initials">{m.mechanic_name.charAt(0)}</div>
