        ...
        <div className="space-y-6">
            <div>
                <div className="flex items-center gap-2 mb-4">
                    <Settings className="text-primary-color" size={20} />
                    <h3 className="font-bold text-lg">1. Informações Básicas</h3>
                </div>
            ...
            <div>
                <div className="flex items-center gap-2 mb-4 pt-4 border-t border-color">
                    ...
                    <h3 className="font-bold text-lg">2. Estoque e Preços</h3>
                </div>
