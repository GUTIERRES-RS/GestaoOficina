        ...
        <div className="space-y-6">
            ...
            <div className="space-y-4">
                ...
                <div className="grid grid-cols-2 gap-4 mb-4">
                    <div
                        className="p-4 rounded-none bg-tertiary pl-2"
            ...
            {/* Section 2: VeÃ­culos Vinculados */}
            <div className="space-y-4">
                <div className="flex justify-between items-center mb-4">
                    <div className="flex items-center gap-2">
                        <Car className="text-primary-color" size={20} />
                        <h3 className="font-bold text-lg">2. VeÃ­culos Vinculados</h3>
                    </div>
                    <span className="badge badge-warning">
                        {vehicles.length} VeÃ­culo(s)
                    </span>
                </div>
                ...
                {vehicles.length > 0 ? (
                                    ...
                                    <div className="flex items-center gap-4">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-xs text-secondary font-medium">
                                                PLACA: {v.plate} â€¢ {v.year || 'Ano N/I'} â€¢ {v.color || 'Cor N/I'}
                                            </p>
                                        </div>
                                    </div>
                                    <div className="flex items-center gap-2">
                    ...
                    <div className="text-center py-12 bg-tertiary border border-dashed border-color rounded-2xl">
                        ...
                        <p className="text-secondary font-medium">Nenhum veÃ­culo vinculado a este cliente.</p>
                    </div>
                )}
            </div>
        </div>
